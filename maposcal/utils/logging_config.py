...
def configure_logging():
    ...
    try:
        ...
        print(f"Creating log file at: {log_file}", file=sys.stderr)  # Debug print to stderr
        file_handler = logging.FileHandler(log_file)
        file_handler.setLevel(logging.INFO)
        file_handler.setFormatter(file_formatter)
        
        # Console handler
        console_handler = logging.StreamHandler(sys.stderr)  # Use stderr for console output
