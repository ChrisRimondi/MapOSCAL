...
sc8_java = ['sslsocket', 'sslcontext', 'keystore', 'truststore', 'httpsurlconnection', 'sslserversocket', 'sslparameters', 'sslcontext.getinstance("tls")', 'sslcontext.init', 'sslengine', 'keymanagerfactory', 'trustmanagerfactory', 'sslcontext.setdefault', 'sslcontext.getdefault', 'system.setproperty("https.protocols")', 'system.setproperty("javax.net.ssl.truststore")', 'system.setproperty("javax.net.ssl.keystore")']
sc8_cpp = ['ssl_ctx', 'ssl_new', 'ssl_connect', 'ssl_accept', 'ssl_write', 'ssl_load_error_strings', 'ssl_library_init', 'openssl_init_ssl', 'bio_new_ssl_connect', 'ssl_ctx_new', 'ssl_ctx_use_certificate_file', 'ssl_ctx_use_privatekey_file', 'ssl_ctx_set_verify', 'ssl_ctx_load_verify_locations', 'tls_method', 'bio_s_mem']