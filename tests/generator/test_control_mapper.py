...
class TestGetRelevantChunks:
    ...
    def test_get_relevant_chunks_basic(self, mock_embedder, mock_meta_store, mock_faiss_index):
    ...
    @patch('maposcal.generator.control_mapper.meta_store')
    @patch('maposcal.generator.control_mapper.local_embedder')
    def test_get_relevant_chunks_with_summary_index(self, mock_embedder, mock_meta_store, mock_faiss_index):
    ...
    @patch('maposcal.generator.control_mapper.meta_store')
    @patch('maposcal.generator.control_mapper.local_embedder')
    def test_get_relevant_chunks_missing_files(self, mock_embedder, mock_meta_store, mock_faiss_index):
...
class TestMapControl:
    ...
    @patch('maposcal.generator.control_mapper.LLMHandler')
    @patch('maposcal.generator.control_mapper.get_relevant_chunks')
    def test_map_control_with_security_overview(self, mock_get_chunks, mock_llm_handler_class):
    ...
    @patch('maposcal.generator.control_mapper.LLMHandler')
    @patch('maposcal.generator.control_mapper.get_relevant_chunks')
    def test_map_control_with_list_statement(self, mock_get_chunks, mock_llm_handler_class):
...
class TestControlMapperIntegration:
    ...
    @patch('maposcal.generator.control_mapper.meta_store')
    @patch('maposcal.generator.control_mapper.LLMHandler')
    def test_full_control_mapping_workflow(self, mock_llm_handler_class, mock_meta_store, mock_faiss_index, mock_embedder):
