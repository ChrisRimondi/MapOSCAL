...
class TestProfileControlExtractor:
    ...
    def test_profile_control_extractor_initialization(self, sample_catalog, sample_profile):
    ...
    def test_extract_control_parameters_basic(self, sample_catalog, sample_profile):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert "develops, disseminates, and reviews/updates" in result["statement"][0]
    ...
    def test_extract_control_parameters_no_params(self, sample_catalog, sample_profile):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert len(result["statement"]) == 1
            assert "protects the confidentiality and integrity" in result["statement"][0]
            assert len(result["params"]) == 0

    def test_extract_control_parameters_nested_statement(self, sample_catalog, sample_profile):
    ...
    def test_extract_control_parameters_mixed_statement(self, sample_catalog, sample_profile):
    ...
    def test_extract_control_parameters_grouped_control(self, sample_catalog, sample_profile):
    ...
    def test_extract_control_parameters_nonexistent_control(self, sample_catalog, sample_profile):
    ...
    def test_extract_control_parameters_no_statement(self, sample_catalog, sample_profile):
    ...
    def test_extract_control_parameters_multiple_resolved_values(self, sample_catalog, sample_profile):
        ...
        multi_value_profile["profile"]["modify"]["set-parameters"][0]["values"] = ["immediately", "within 30 days"]
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert len(result["params"][0]["resolved-values"]) == 3  # 1 from constraints + 2 from values
            assert "immediately" in result["params"][0]["resolved-values"]
            assert "within 30 days" in result["params"][0]["resolved-values"]

    def test_extract_control_parameters_value_field(self, sample_catalog, sample_profile):
    ...
    def test_extract_control_parameters_param_with_prose(self, sample_catalog, sample_profile):
        ...
        prose_catalog["catalog"]["controls"][0]["params"][0]["prose"] = "Default prose value"
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert len(result["params"][0]["prose"]) == 2  # 1 from guidelines + 1 from prose
