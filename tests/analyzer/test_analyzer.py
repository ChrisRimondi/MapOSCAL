...
# Note: Removed test_analyzer_metadata_injection and test_analyzer_metadata_backward_compatibility
# tests due to chunker ignoring test directories containing "test" in the path
